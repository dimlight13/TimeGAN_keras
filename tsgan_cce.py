...
class TSGAN:
    def __init__(self, dataset, label, is_train=False):
        ...
        self.hidden_dim = int(self.latent_dim/4)
    ...
    def save_process(self, epoch):
        ...
        self.final_d_model.save(PATH + "d_model_{}.h5".format(epoch))
...
if __name__ == "__main__":
    ...
    del scaled_x
    model = TSGAN(X_train, Y_train, is_train=False)
    model.train()